...
template <class TComplexArray1D>
bool FFT(TComplexArray1D & data_in, TComplexArray1D & data_out,
...
template <class TComplexArray2D>
bool FFT(TComplexArray2D & data_in, TComplexArray2D & data_out,
...
template <class TComplexArray3D>
bool FFT(TComplexArray3D & data_in, TComplexArray3D & data_out,
...
template <class TComplexArray1D>
bool IFFT(TComplexArray1D & data_in, TComplexArray1D & data_out,
          const size_t size, const char *& error_description)
{
    copy_array::copyArray(data_in, data_out, size);
...
template <class TComplexArray2D>
bool IFFT(TComplexArray2D & data_in, TComplexArray2D & data_out,
          const size_t size1, const size_t size2, const char *& error_description)
{
    copy_array::copyArray(data_in, data_out, size1, size2);
    return impl::CFFT<TComplexArray2D,2>::FFT_inplace(data_out, size1, size2,
...
template <class TComplexArray3D>
bool IFFT(TComplexArray3D & data_in, TComplexArray3D & data_out,
          const size_t size1, const size_t size2, const size_t size3,
          const char *& error_description)
{
    copy_array::copyArray(data_in, data_out, size1, size2, size3);
...
bool FFT(TRealArray1D & data_in, TComplexArray1D & data_out,
         const size_t size, const char *& error_description)
{
    copy_array::copyArray(data_in, data_out, size);
...
bool FFT(TRealArray2D & data_in, TComplexArray2D & data_out,
         const size_t size1, const size_t size2, const char *& error_description)
{
    copy_array::copyArray(data_in, data_out, size1, size2);
    return impl::CFFT<TComplexArray2D,2>::FFT_inplace(data_out, size1, size2,
...
bool FFT(TRealArray3D & data_in, TComplexArray3D & data_out,
         const size_t size1, const size_t size2, const size_t size3,
         const char *& error_description)
{
    copy_array::copyArray(data_in, data_out, size1, size2, size3);
