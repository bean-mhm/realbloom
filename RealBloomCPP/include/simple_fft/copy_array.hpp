...
void copyArray(TComplexArray1D & data_from, TComplexArray1D & data_to,
               const size_t size)
{
...
void copyArray(TRealArray1D & data_from, TComplexArray1D & data_to,
               const size_t size)
{
    int size_signed = static_cast<int>(size);
...
void copyArray(TComplexArray2D & data_from, TComplexArray2D & data_to,
...
void copyArray(TRealArray2D & data_from, TComplexArray2D & data_to,
               const size_t size1, const size_t size2)
{
    int size1_signed = static_cast<int>(size1);
    int size2_signed = static_cast<int>(size2);
...
void copyArray(TComplexArray3D & data_from, TComplexArray3D & data_to,
...
void copyArray(TRealArray3D & data_from, TComplexArray3D & data_to,
               const size_t size1, const size_t size2, const size_t size3)
{
    int size1_signed = static_cast<int>(size1);
    int size2_signed = static_cast<int>(size2);
