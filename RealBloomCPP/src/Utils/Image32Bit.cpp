...
Image32Bit::Image32Bit(uint32_t id, std::string name, uint32_t width, uint32_t height, ImVec4 fillColor)
    : m_id(id), m_name(name), m_width(width), m_height(height), m_imageData(nullptr), m_imageDataSize(0), m_glTexture(0)
{
    resize(width, height);
    fill(fillColor);
}
...
Image32Bit::Image32Bit(uint32_t id, std::string name, uint32_t squareSize, ImVec4 fillColor)
    : m_id(id), m_name(name), m_width(squareSize), m_height(squareSize), m_imageData(nullptr), m_imageDataSize(0), m_glTexture(0)
{
